...
MACRO (MYSQL_CHECK_SSL)
  ...
  IF(WITH_SSL STREQUAL "system" OR WITH_SSL_PATH)
    ...
    CHECK_SYMBOL_EXISTS(DH_GENERATOR_2 "openssl/dh.h" TEST)
    MESSAGE (STATUS "TEST = ${TEST}")
    MESSAGE (STATUS "OPENSSL_FOUND = ${OPENSSL_FOUND}")
    MESSAGE (STATUS "HAVE_SHA512_DIGEST_LENGTH = ${HAVE_SHA512_DIGEST_LENGTH}")
    IF(OPENSSL_FOUND AND HAVE_SHA512_DIGEST_LENGTH)
      ...
      SET(SSL_DEFINES "-DHAVE_OPENSSL ${SSL_COMPAT}")
    ELSE()
